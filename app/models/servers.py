...
class Server(db.Model):
    ...
    def to_dict(self):
        return {
            ...
            'members' : [{'username': member.users.username, 'profile_picture' : member.users.profile_picture, 'permission' :member.permissions.permission, 'user_id': member.users.id} for member in self.server_members]
        }
