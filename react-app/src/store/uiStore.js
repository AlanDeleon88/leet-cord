//! could use redux stores to save states on channel buttons and maybe the add server button, like for example,
//! whenever a server icon is pushed it will dispatch to the add icon store to set active to false,
//! when you click on add server icon it will change its active to true.
/*
